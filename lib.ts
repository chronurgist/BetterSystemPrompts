...
export function expandAtRefs(content: string, baseDir: string, depth = 0): string {
...
export function replaceBlockContent(prompt: string, filePath: string, newContent: string): string {
...
export function insertAfterBlock(prompt: string, filePath: string, insertion: string): string {
